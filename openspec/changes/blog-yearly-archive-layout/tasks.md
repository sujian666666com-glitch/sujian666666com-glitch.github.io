...
- [x] 7.2 正确期望行为：四个博客索引模块保留统一年度索引结构，但顶部背景板和标题强调色呈现不同主题色。
- [x] 7.3 本次实现方式：为博客索引页增加 `blog-archive-page--all/tech/thought/life` modifier class，并通过 CSS 变量分别定义红铜、蓝青、靛紫、橄榄绿主题；非博客栏目不套用这些主题。
