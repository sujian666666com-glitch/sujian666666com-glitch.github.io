...
- [x] 5.3 修复 daily 左侧日期目录只能显示到 2026-05-10 的问题：现象是日期导航 partial 默认截取最近 18 篇，导致 2026-05-28 更新后只能回看至 05.10；正确期望是左侧目录可滚动访问全部每日新闻历史；本次让 partial 默认展示全部条目，并保留可选 `limit` 参数供未来特殊场景显式限制。
