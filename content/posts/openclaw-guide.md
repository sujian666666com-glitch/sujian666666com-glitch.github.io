...
author: "苏健"
cover:
  image: "https://mintcdn.com/clawdhub/FaXdIfo7gPK_jSWb/assets/openclaw-logo-text.png"
---

> **OpenClaw** 是一个自托管的 AI 网关，让你通过 WhatsApp、Telegram、Discord、iMessage 等常用聊天应用与 AI 助手对话。运行在你的设备上，数据由你掌控。

![OpenClaw Logo](https://mintcdn.com/clawdhub/FaXdIfo7gPK_jSWb/assets/openclaw-logo-text.png)
...
![OpenClaw WhatsApp Demo](https://mintcdn.com/clawdhub/FaXdIfo7gPK_jSWb/whatsapp-openclaw.jpg)
...
![Install Script Process](https://mintcdn.com/clawdhub/A8OxQpxR3DcyCCHY/assets/install-script.svg)
